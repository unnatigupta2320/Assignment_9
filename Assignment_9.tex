...
\begin{align}
    ...
    \\
    \implies det\myvec{1-\lambda&2&3\\3&-2-\lambda&1\\4&2&1-\lambda}&=0
    \end{align}
\begin{multline}
...
\end{multline}
\begin{multline}
   \implies\brak{1-\lambda}\brak{\lambda+\lambda^2-4}
   \\
   -2\brak{-1-3\lambda}+3\brak{14+4\lambda}=0
\end{multline}
\begin{multline}
   \implies-\lambda^3+5\lambda-4
   \\
   +2+6\lambda+42+12\lambda=0
\end{multline}
\begin{align}
